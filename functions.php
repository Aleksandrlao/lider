...
function register_my_menus(){
 	register_nav_menus( array( 'tnav' => 'Меню в Шапке', 'snav' => 'Меню в сайдбаре' ) );
...
register_sidebar(array('name'=>'Футер',
    'before_widget' => '<div class="c_bottom-box">',
    'after_widget' => '</div>',
    'before_title' => '<div class="c_bottom-head">',
    'after_title' => '</div>',
));
